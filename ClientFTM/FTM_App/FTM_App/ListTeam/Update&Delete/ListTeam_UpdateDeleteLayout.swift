//
//  ListTeam_UpdateDeleteLayout.swift
//  FTM_App
//
...
extension ListTeam_UpdateDelete {
    ...
    func setupLayout() {
        ...
        NSLayoutConstraint.activate([
            ...
            lbl_Tittle.widthAnchor.constraint(equalTo: view1.widthAnchor, multiplier: 0.8),
        ...
        let stackView_UpdateDel = UIStackView(arrangedSubviews: [btn_UpdateListTeam, btn_DeleteListTeam])
        stackView_UpdateDel.translatesAutoresizingMaskIntoConstraints = false
        stackView_UpdateDel.axis = .horizontal
        stackView_UpdateDel.distribution = .fillEqually
        stackView_UpdateDel.spacing = 16
        
        view3.addSubview(stackView_UpdateDel)
        NSLayoutConstraint.activate([
            stackView_UpdateDel.centerXAnchor.constraint(equalTo: view3.centerXAnchor),
            stackView_UpdateDel.centerYAnchor.constraint(equalTo: view3.centerYAnchor),
            stackView_UpdateDel.widthAnchor.constraint(equalTo: view3.widthAnchor, multiplier: 0.8),
            stackView_UpdateDel.heightAnchor.constraint(equalTo: view3.heightAnchor, multiplier: 0.5)
        ])
    }
